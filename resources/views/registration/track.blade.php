...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Track Status') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('get_status') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cid" type="text" class="form-control @error('cid') is-invalid @enderror" name="cid" required >
